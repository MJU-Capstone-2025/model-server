...
변동성 관련 추가 특성과 튜닝된 하이퍼파라미터를 사용한다.
...
간단한 사용 예시:
    from app.models.time_series.attention_lstm_2 import main
...
from .data_preprocessing import load_and_prepare_data, train_test_split, scale_data, add_volatility_features
